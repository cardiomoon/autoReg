...
For bootstraping simulation, you can make new dat with the following R code.
```{r}
...
You can make a bootstraping simuation with bootPredict() function. You can set the number of simlation by adjusting R argument.
```{r}
...
With this result, you can draw a plot showing bootstraping prediction of breast cancer.
